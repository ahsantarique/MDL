...
if __name__ == "__main__":
    ...
    DataCost = TimeSeriesCost((Result_p[:len(YCases)]/p_alpha-YReports)/(1-p_alpha)-(Result_p[:len(YCases)]/p_alpha))
    ...
    ModelCost = ModelCost1 + ModelCost2 + ModelCost3
    DataCost = TimeSeriesCost((YCases-YReports)/(1-Parameter_pp[0])-(Result_pp[len(YCases):2*len(YCases)]))
    MDLCost = ModelCost + DataCost
